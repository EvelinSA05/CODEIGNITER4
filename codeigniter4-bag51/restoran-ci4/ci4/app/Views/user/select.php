...
<div class="col">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="<?=base_url()?>/admin/user/update/<?= $value['iduser'] ?>/<?= $value['aktif'] ?>" class="btn btn-success"><?= $aktif ?></a>
            </td>
            <td><a href="<?=base_url()?>/admin/user/delete/<?= $value['iduser']?>"><img src="<?=base_url('/icon/tra.svg')?>"></a>
